...
export default function Cadastro() {
    return (
        <>
            <h1 className=" green text-center my-5">Bem-vindo à sua próxima viagem!!!<br /><br />Faça seu Cadastro</h1>
                    ...
                    <div className="card-body p-4 p-lg-5 text-black">
                        ...
                        <form>
                            ...
                            <div className="form-outline mb-4">
                                ...
                                <label className="form-label" for="form2Example27">Repita sua senha</label>
                            </div>
